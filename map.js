...
mapboxgl.accessToken = 'pk.eyJ1Ijoic2hhbnRndWUiLCJhIjoiY21oc2p4c3RuMWthbTJpcGoxdHdydG10cSJ9.YxNof4BJ3mxxNKOUzPgoeQ';
...
map.on('load', async () => {
  ...
  map.addLayer({
    ...
    const circles = svg
        .selectAll('circle')
        .data(stations, (d) => d.short_name) // Use station ID as key
        .enter()
        .append('circle')
